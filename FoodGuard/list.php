...
<div class="logo" style="display: flex; align-items: center;">
      ...
      <a class="active" href="">List of Cafes and Restaurants</a>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<li><a href='view_restaurant.php?id={$row['id']}' style='color: #fff; text-decoration: none; padding: 10px; border: 2px solid #333; border-radius: 8px; display: block; font-weight: bold; font-size: 18px; transition: background-color 0.3s;'>{$row['restaurant_name']}</a></li>";
    }
    echo "</ul>";
} else {
