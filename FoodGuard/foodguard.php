...
/* Define CSS class for header */ .header { font-family: Arial, sans-serif; color: black; background-color: #F8F8F8; padding: 20px; text-align: center; font-size: 28px; }

/* Define CSS class for title */ .title { font-family: Arial, sans-serif; color: black; background-color: #F8F8F8; padding: 20px; text-align: center; font-size: 24px; }
...
/* Define CSS class for main content */ .main { font-family: Arial, sans-serif; color:black; padding: 20px; margin: 20px; background-color: #F8F8F8; text-align: center; font-size: 16px; }
...
<!-- <?php
    ...
    //?> -->
      ...
      <a href="http://localhost/FoodGuard/review.php">Review Page</a>
...
<div class="content">
  <h2 style="color:Black">Welcome to FoodGuard!</h2>
